...
class Loader:
    ...
    def load_images(self):
        ...
        # Load bars
        texture.add("load_bar00",arcade.Sprite("assets/buttons/load_bar00.png"))
        texture.add("load_bar01",arcade.Sprite("assets/buttons/load_bar01.png"))
        texture.add("load_bar02",arcade.Sprite("assets/buttons/load_bar02.png"))
        texture.add("load_bar03",arcade.Sprite("assets/buttons/load_bar03.png"))
        texture.add("load_bar04",arcade.Sprite("assets/buttons/load_bar04.png"))
        texture.add("load_bar05",arcade.Sprite("assets/buttons/load_bar05.png"))
        texture.add("load_bar06",arcade.Sprite("assets/buttons/load_bar06.png"))
        texture.add("load_bar07",arcade.Sprite("assets/buttons/load_bar07.png"))
        texture.add("load_bar08",arcade.Sprite("assets/buttons/load_bar08.png"))
        texture.add("load_bar09",arcade.Sprite("assets/buttons/load_bar09.png"))
        texture.add("load_bar10",arcade.Sprite("assets/buttons/load_bar10.png"))
        texture.add("load_bar11",arcade.Sprite("assets/buttons/load_bar11.png"))
        texture.add("load_bar12",arcade.Sprite("assets/buttons/load_bar12.png"))
        texture.add("load_bar13",arcade.Sprite("assets/buttons/load_bar13.png"))
        texture.add("load_bar14",arcade.Sprite("assets/buttons/load_bar14.png"))
        texture.add("load_bar15",arcade.Sprite("assets/buttons/load_bar15.png"))
        texture.add("load_bar16",arcade.Sprite("assets/buttons/load_bar16.png"))
        texture.add("load_bar17",arcade.Sprite("assets/buttons/load_bar17.png"))
        texture.add("load_bar18",arcade.Sprite("assets/buttons/load_bar18.png"))
        texture.add("load_bar19",arcade.Sprite("assets/buttons/load_bar19.png"))
